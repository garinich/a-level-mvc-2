namespace DataAccessLayer.Migrations
{
    ...
    public partial class Add_Identity_Models : DbMigration
    {
        public override void Up()
        {
            RenameTable(name: "dbo.Emploees", newName: "AspNetUsers");
        ...
        public override void Down()
        {
            ...
            AddPrimaryKey("dbo.AspNetUsers", "Id");
            RenameTable(name: "dbo.AspNetUsers", newName: "Emploees");
        }
    }
}
